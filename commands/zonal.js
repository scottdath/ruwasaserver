...
export const zncommandFetch = async() =>
{   
                          ...
                          if (metertype==='@ruwasazn'){
                            ...
                            const ids = full_list[1].toLowerCase()
                                ...
                                if (name=="status"){
                                    ...
                                    if (value=='1'){
                                        stat = 'Online'
                                        const q = "UPDATE znmessages SET status = ? WHERE meterno = ?"
                                    ...
                                    if (value=='1'){
                                        stat = 'Registered'
                                        const q = "UPDATE znmessages SET regstatus = ? WHERE meterno = ?"
                                    ...
                                    if (value=='1'){
                                        stat = 'Reset!'
                                        const q = "UPDATE znmessages SET resetstatus = ? WHERE meterno = ?"
                                    ...
                                    if (value=='1'){
                                        stat = 'Memory Cleared!'
                                        const q = "UPDATE znmessages SET clearstatus = ? WHERE meterno = ?"
                                    ...
                                    const q = "UPDATE znmessages SET litres = ? WHERE meterno = ?"
